defmodule ACTest do
  ...
  test "advent 8" do
    assert AC.Eight.problem1() == AC.Eight.test_output_part1()

    assert AC.Eight.problem2() == AC.Eight.test_output_part2()
  end

  test "advent 9" do
    assert AC.Nine.problem1() == AC.Nine.test_output_part1()
  ...
  test "advent 10" do
    assert AC.Ten.problem1() == AC.Ten.test_output_part1()
